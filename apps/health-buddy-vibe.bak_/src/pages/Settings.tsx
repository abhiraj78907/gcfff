...
const Settings = () => {
  ...
  const [language, setLanguage] = useState(() => localStorage.getItem("patient_language") || "hindi");
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-6">
        ...
        <Card className="p-5">
          ...
          <Select value={language} onValueChange={(val) => {
            setLanguage(val);
            localStorage.setItem("patient_language", val);
            document.documentElement.lang = val === 'english' ? 'en' : val === 'kannada' ? 'kn' : 'hi';
            toast({ title: "Language updated", description: `Current: ${val}` });
          }}>
