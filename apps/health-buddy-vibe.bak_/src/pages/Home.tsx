  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-8">
        ...
        {/* Medicine Tracker - Horizontal, compact cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 items-stretch">
          <div className="flex flex-col h-full">
            {getMedicinesByPeriod("morning").length > 0 && (
              <TimelineSection title="Morning" icon="🌅" showGuides={false}>
                <div className="flex flex-col gap-2 lg:max-h-[420px] overflow-auto pr-1">
          ...
          <div className="flex flex-col h-full">
            {getMedicinesByPeriod("afternoon").length > 0 && (
              <TimelineSection title="Afternoon" icon="☀️" showGuides={false}>
                <div className="flex flex-col gap-2 lg:max-h-[420px] overflow-auto pr-1">
          ...
          <div className="flex flex-col h-full">
            {getMedicinesByPeriod("night").length > 0 && (
              <TimelineSection title="Night" icon="🌙" showGuides={false}>
                <div className="flex flex-col gap-2 lg:max-h-[420px] overflow-auto pr-1">
